...
import { CreditCard, CheckCircle2, ArrowUpRight, ShieldCheck, Calendar } from 'lucide-react';

export default function BillingSettings({ params: _params }: { params: { slug: string } }) {
  const features = [
    'Imóveis ilimitados',
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-y-3">
              {features.map((feature) => (
                <div
                  key={feature}
                  className="flex items-center gap-3 text-muted-foreground text-sm font-medium"
                >
            ...
            <div className="p-4 border-2 border-border rounded-xl bg-muted/30">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <div className="w-10 h-6 bg-foreground rounded flex items-center justify-center text-[8px] text-background font-bold italic">
                    VISA
                  </div>
